...
index: '04'
type: 'ML'
summary: 'A real-time, server-side pipeline that monitors elderly care home residents through their smartphones and alerts staff the moment a fall is confirmed, built with a Flask/Flask-SocketIO server and a PyTorch GRU model, containerized with Docker.'
