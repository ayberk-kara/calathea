...
<Callout label="If you remember one thing:">
  Faster math can't move a point that's sitting on the bandwidth diagonal. To
  go faster you have to move right — raise the intensity by reusing each byte
  you fetch.
</Callout>
